...
if (room == rm_prehistoric) { path_id = choose(path_prehistoric1, path_prehistoric2); }
if (room == rm_medieval) { path_id = choose(path_medieval1, path_medieval2, path_medieval3); }
if (room == rm_modern) { path_id = choose(path_modern1, path_modern2, path_modern3); }
